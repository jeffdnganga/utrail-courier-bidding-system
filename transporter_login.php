                    ...
                    <form class="login-form bg-white mx-md-5 mx-sm-0">
                        ...
                        <div class="row text-center">
                            <div class="col-sm-12 col-md-4 py-2">
                                <a class="p" href="transporter_registration.php">Register</a>
                            </div>
                            <div class="col-sm-12 col-md-4 py-2">
            ...
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="assets/images/transporter-login-image2.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-block">
                            <h5>Step 2</h5>
                            <h3>View and review some of the new deliveries posted in your route</h3>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="assets/images/transporter-login-image3.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-block">
                            <h5>Step 3</h5>
                            <h3>Make a bid on some deliveries</h3>
                        </div>
                    </div>
                </div>
            </div>        
