...
?>
<div class="container-fluid transporter-registration">
    <div class="row">
            <div class="col1 col-lg-6 col-sm-12">
                ...
                <div class="registration-form-div px-sm-0 px-md-5">
                    ...
                    <div class="section-heading text-center">
                        <h2 class="hover-underline-animation fw-bold text-center mt-2" style="color: #3D5A80;"><span class="unique-heading-section">Join </span>Our Team</h2>
                    </div>
                    ...
                    <form class="registration-form bg-white mx-md-5 mx-sm-0">
                        ...
                        <p>Already have an account? <a class="p" href="transporter_login.php">Login</a></p>
                    </form>
                </div>
            </div>
        <div class="col2 col-lg-6 col-sm-12 d-none d-lg-block">
            <div class="register-message">
                <div class="register-message-text text-left">
                    <h3>We are a team of committed experts<br><span class="fw-bold">Create an account</span><span class="h4"> to join our team.</span></h3>
